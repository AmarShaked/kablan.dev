...
import koWarzone from './locales/ko/warzone.json';
...
import zhHansWarzone from './locales/zh-Hans/warzone.json';
...
import zhHantWarzone from './locales/zh-Hant/warzone.json';
