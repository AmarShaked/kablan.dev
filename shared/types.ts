 ...
 */
auto_fetch_enabled: boolean, auto_fetch_interval_minutes: number, commit_reminder_enabled: boolean, commit_reminder_prompt: string | null, send_message_shortcut: SendMessageShortcut, };
