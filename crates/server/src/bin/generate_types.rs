...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::project::ProjectWithStats::decl(),
        db::models::repo::Repo::decl(),
        db::models::repo::UpdateRepo::decl(),
        server::routes::repo::EnvFile::decl(),
        server::routes::repo::SaveEnvFile::decl(),
        server::routes::task_attempts::env_files::WorkspaceEnvFile::decl(),
        server::routes::task_attempts::env_files::SaveWorkspaceEnvFile::decl(),
        ...
        db::models::task::ArchiveFilter::decl(),
        server::routes::tasks::SetArchivedRequest::decl(),
        ...
        server::routes::task_attempts::PullError::decl(),
        ...
        services::services::config::TimeFormat::decl(),
        services::services::config::IntegrationProvider::decl(),
        services::services::config::LinearConfig::decl(),
        services::services::linear::LinearIssue::decl(),
        services::services::linear::LinearComment::decl(),
        services::services::linear::LinearViewer::decl(),
        services::services::linear::LinearPageInfo::decl(),
        services::services::linear::LinearIssuesResponse::decl(),
        services::services::linear::LinearIdName::decl(),
        services::services::linear::LinearWorkflowState::decl(),
        services::services::linear::LinearMetaResponse::decl(),
        server::routes::integrations::ConnectLinearBody::decl(),
        server::routes::integrations::ConnectLinearResponse::decl(),
        git::GitBranch::decl(),
